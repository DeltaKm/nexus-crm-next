...
-- CreateIndex
CREATE UNIQUE INDEX "invoice_items_time_entry_id_key" ON "invoice_items"("time_entry_id");
...
-- AddForeignKey
ALTER TABLE "clients" ADD CONSTRAINT "clients_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
